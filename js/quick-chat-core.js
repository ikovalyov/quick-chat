...
var quick_chat = jQuery.extend(quick_chat || {}, {
    ...
    single_message_html: function(single_message, avatars, sys_mes){
        ...
        string += '<div class="quick-chat-history-timestring">'+single_message.timestring+'</div><div class="quick-chat-history-message">'+message_with_smile+'</div></div>';
                            ...
                            if(room_name == updates[i].room){
                                if(updates[i].alias != 'quick_chat'){
                                    if( already_notified == 0
                                        ...
                                        jQuery("#messcount").html(parseInt( jQuery("#messcount").html() ) + 1);
