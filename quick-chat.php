	...
	load_plugin_textdomain('quick-chat', false, dirname($this->basename) . '/languages/');
        ...
        if(is_user_logged_in()){
            ...
            /*if(isset($_COOKIE['quick_chat_alias_'.$current_user->ID])){
                ...
                setcookie('quick_chat_alias_'.$current_user->ID, $current_user->nickname, 0, COOKIEPATH, COOKIE_DOMAIN);*/
                $this->user_name =  $current_user->nickname;
/*            }*/
    ...
    public function username_check_ajax_handler(){
        ...
        if($this->no_participation == 0){
            ...
            if($_POST['username_check'] != $this->user_name){
                ...
                if($username_bad_words == 0 && (!is_user_logged_in() || (is_user_logged_in() && strcasecmp($_POST['username_check'], $current_user->nickname) != 0))){
